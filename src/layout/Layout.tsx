    ...
    return (
        <div className="main-layout-container">
            ...
            <ul className="menu-ul-list">
                ...
                <li className="menu-item" style={{ background: routerSelect === "about" ? "#E7F7FF" : "transparent" }}><a href="/" onClick={() => handleRouterSelect("about")}>Registro de Atas</a></li>
                <li className="menu-item" style={{ background: routerSelect === "signature" ? "#E7F7FF" : "transparent" }}><a href="/" onClick={() => handleRouterSelect("signature")}>Assinatura<FaCircle color="red" size={13} className="ml-2 pointer-events-none animate-pulse" /></a></li>
                <li className="menu-item" style={{ background: routerSelect === "calendar" ? "#E7F7FF" : "transparent" }}><a href="/" onClick={() => handleRouterSelect("calendar")}>Calendário</a></li>
                <li className="menu-item" style={{ background: routerSelect === "history" ? "#E7F7FF" : "transparent" }}><a href="/" onClick={() => handleRouterSelect("history")}>Histórico</a></li>
            </ul>
